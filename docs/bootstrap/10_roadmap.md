...
active_milestone:
  ...
  latest_release_issue: "#317"
  latest_release_url: https://github.com/stereosurfer/agent-safe-dev-governance-kit/releases/tag/v1.7.2
...
likely_next_directions:
  ...
  future_v1_x_release:
    ...
    status: human_gated
    note: "Any release after v1.7.2 must start from a separate durable issue with exact tag, title, target commit, final validation, product-entry/handoff closeout plan, and rollback or revoke plan."
