...
| `runtime_adapter_profile_decision` | `roadmap` or `v2_0` | `frontier` | yes | `docs/adapters/README.md`, `docs/adapters/ADAPTER_TEMPLATE.md`, `docs/DOCUMENT_REGISTRY.md` | vendor docs, observed tests, adapter boundary, non-bypass claim, future profile file named by the v2 issue | vendor docs missing, runtime behavior unverified, core governance bypassed |
