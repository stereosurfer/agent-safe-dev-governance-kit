...
| `release_or_publication_decision` | `release` | `frontier` | yes | `docs/control/V1_READINESS_AUDIT.md`, `docs/control/V1_1_STABILIZATION_PLAN.md`, `docs/bootstrap/17_readiness_audit_policy.md` | readiness audit, field-test result, known gaps, rollback/revoke plan | readiness not updated, field test incomplete, unresolved blockers |
