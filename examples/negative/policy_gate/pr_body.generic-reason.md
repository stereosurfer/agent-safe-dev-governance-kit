...
Negative fixture for a generic Merge Decision reason.
...
The empty judgment text is the only intended defect.
...
The reason does not name evidence, limits, or judgment.
