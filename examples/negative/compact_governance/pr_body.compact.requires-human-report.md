...
Compact PR body fixture that references a report requiring human review.
...
```yaml
compact_pr_report:
  report_source: examples/negative/compact_governance/reports/pr-report.requires-human-restricted-boundary.json
  report_result: requires_human
...
validation_evidence:
  local_commands:
    - command: "compact-pr-body-check fixture"
      ...
      evidence: "Fixture body is structurally valid but report requires human review."
      limits: "Fixture only."
  ci_checks:
    - name: validate
      status: passed
...
merge_decision:
  ...
  durable_source_of_truth: "GitHub issue #1005, this PR body, and compiled report fixture"
  checks_passed: true
  ...
  reason: "Fixture demonstrates that a compact body cannot clear requires_human state."
```
